...
<div class="flex h-screen p-2 bg-gray-100">
  <div class="w-8/12 h-full p-2">
    <div class="w-full h-full shadow bg-gray-50" bind:this={canvasParent}>
      <canvas width="100" height="100" bind:this={canvas} />
    </div>
  </div>
  <div class="w-4/12 h-full p-2">
    <div class="w-full h-full shadow bg-gray-50" />
  </div>
</div>
